...
Vamos programar?
[Como executar um script, Passo a Passo.](https://github.com/caiocr94/helpjs#como-executar-um-script)



## Just.... DO IT:
  - (1) Faça uma mensagem de **'Olá Mundo'** (Pode ser com alert ou uma mensagem na tela com .innerHTML)
  - (2) Faça essa mensagem em um arquivo javascript externo e chame ela... **([Importado](https://github.com/caiocr94/helpjs#importado))**
...
```   
  [Monitorando-Click](https://github.com/caiocr94/helpjs#monitorando-um-evento-click)  
  [Exibir o nome ao clicar](https://github.com/caiocr94/helpjs#exibir-o-nome-ao-clicar)  

  - (5) exiba a quantidade de letras que possuem o texto inserido ao clicar no botão ({variavel do nome}.length)
```
...
```
  ...
  https://github.com/caiocr94/helpjs/blob/master/images/lampada.jpg?raw=true  

  //SRC da Lampada (acessa)  
  https://github.com/caiocr94/helpjs/blob/master/images/lampada-on.jpg?raw=true
  ```  
  ... - [Alterar-Src de Img](https://github.com/caiocr94/helpjs#alterar-um-atributo-do-html)   
...
```   
  ...
  - (12.a) Crie dois botões no HTML chamados: 'Verde', ,'Vermelho'. ao clicar neles, o style="background-color: {COR-SELECIONADA}" vai ser alterado dinamicamente [Alterar-Style de uma div](https://github.com/caiocr94/helpjs#alterar-style-div)   
...
Adicione os 3 Deuses: ('Loki', 'Odin', 'Frey') e mostre a quantidade com a função [.length](http://www.w3schools.com/jsref/jsref_length_string.asp)  
...
- (41) Crie um contador como o abaixo: @dica: [setTimeout]([https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Array/sort](https://www.w3schools.com/jsref/met_win_settimeout.asp))   
<img src="https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/contador-gif-5.gif" alt="Contador" width="width: 60px;"/>


## Challenge Accepted  

- (42) 
<img src="https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/meme-challenge-accepted.jpg" alt="Challenge Accepted Meme" width="300px"/>

Com as imagens abaixo:
![Animação Urso](https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/all-chara.png)
...
<img src="https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/urso-animado.gif" alt="Urso Animado"/>


@Dica: Já deixei cortado cada uma com ( 32px x 32px )
```    
  https://raw.githubusercontent.com/caiocr94/helpjs/master/images/chara-1.png
  https://raw.githubusercontent.com/caiocr94/helpjs/master/images/chara-2.png
  https://raw.githubusercontent.com/caiocr94/helpjs/master/images/chara-3.png
```

Basicamente você pode usar os exemplos abaixo:  
[Exemplo de temporizador/setTimeout()](https://github.com/caiocr94/helpjs#exemplo-de-temporizador)     
[Alterar-Style de uma div](https://github.com/caiocr94/helpjs#alterar-style-div)  
[Alterar-Src de Img](https://github.com/caiocr94/helpjs#alterar-um-atributo-do-html)   
...
## Tópicos futuros:
  - [Importado](https://github.com/caiocr94/helpjs#just-do-it-arrays) - Arrays/Matrizes/Vetores?
  - Classes/Prototype
  - JSON
...
![Código HTML + JavaScript](https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/1.png)

  - Clique em 'Arquivo' -> 'Salvar Como'
![Salvar->Salvar Como](https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/2.png)

  - Escolha uma pasta, (de preferencia crie uma para cada exercício. **Exemplo: 'ex', 'ex1', ...)** )
![Salve o arquivo](https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/3.png)
...
![Salve o arquivo](https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/4.png)

  - Prontinho... Seu código foi executado  
![Salve o arquivo](https://raw.githubusercontent.com/caiocr94/helpjs/master/img-readme/5.png)  
...
...
<body>
  <img src="https://github.com/caiocr94/helpjs/blob/master/images/lampada.jpg?raw=true" alt="Minha Foto" id="my-photo"/>
  <script type="text/javascript">
    document.getElementById("my-photo").src = 'https://github.com/caiocr94/helpjs/blob/master/images/lampada-on.jpg?raw=true';
  </script>
</body>
...
```
...
# Ainda tem dúvida? Cria um 'Issue' tio....
  -  https://github.com/caiocr94/helpjs/issues 
